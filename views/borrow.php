            ...
            <div class="container-fluid">
                ...
                <ol class="breadcrumb" id="breadcrumb" style="background: rgb(26, 76, 79);">
                    <li class="breadcrumb-item">
                        <a style="color: rgb(211, 209, 207);" href="/LMS/views/" id="breadhead">Dashboard</a>
                    </li>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-dark table-hover" style="border-color: rgb(5, 16, 17); " id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    $query = "SELECT * FROM borrow INNER JOIN books ON borrow.book_id = books.b_id INNER JOIN users ON borrow.user_id = users.u_id";
                                    ...
                                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                        echo '<tr>
                                                ...
                                                <td><span class="text-center text-white"><a href="borrow_edit.php?id=' . $row['id'] . '"name="edit" class="btn btn-success text-white"><i class="fa fa-fw fa-edit"></i></a></span></td>
                                                <td><span class="text-center text-white"><a href="borrow_delete.php?id=' . $row['id'] . '"name="delete" class="btn btn-danger text-white"><i class="fa fa-fw fa-trash"></i></a></span></td>
                                            </tr>';
                                    }
                                    ?>
                                </tbody>
