                                ...
                                <tbody>
                                    ...
                                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                        echo '<tr>
                                                ...
                                                <td>' . $row['author'] . '</td>
                                                <td>' . $row['publisher'] . '</td>
                                                <td><span class="text-center text-white"><a href="book_edit.php?id=' . $row['b_id'] . '"name="edit" class="btn btn-success text-white"><i class="fa fa-fw fa-edit"></i></a></span></td>
                                                <td><span class="text-center text-white"><a href="book_delete.php?id=' . $row['b_id'] . '"name="delete" class="btn btn-danger text-white"><i class="fa fa-fw fa-trash"></i></a></span></td>
                                            </tr>';
                                    }
                                    ?>
                                </tbody>
